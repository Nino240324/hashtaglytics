...
//   best_rank, worst_rank, rank_spread, points_seen,
//   best_lat, best_lng, best_zoom                        -> scoped to this
//     lead's own campaign, NOT business_snapshots -- replaces the removed
//     maps_position, which was shared across every agency and campaign
//     and survived the deletion of the campaign that produced it.
...
export type Prospect = {
  ...
  keyword: string;
  // REPLACES maps_position, which was the best rank ever seen across
  // every campaign and agency -- and survived the deletion of the
  // campaign that produced it. These are scoped to this lead's own
  // campaign.
  best_rank: number | null;
  worst_rank: number | null;
  rank_spread: number | null;
  points_seen: number | null; // not displayed -- see the brief

  // The GRID POINT where the business ranked best, for the Maps link.
  // Never the business's own coordinates: a service-area listing carries
  // a city placeholder.
  best_lat: number | null;
  best_lng: number | null;
  best_zoom: number | null;
  // The campaign's own commune -- a campaign has exactly one, so this
  // costs nothing on the view (already joins campaign_grids). Null only
  // for the six historical, region-scoped campaigns nothing creates any
  // more, but whose leads still exist.
  campaign_commune: string | null;
  // For the Fiche Google link -- the business's OWN listing (photos,
  // reviews, hours, claimed status), distinct from best_lat/lng/zoom
  ...
  // The actual URL, only meaningful when website_kind is 'own' -- but
  // can still be null even then, if the URL was never captured.
  // website_kind says WHAT SORT of site it is; this says WHERE.
  website: string | null;
...
export const mockProspects: Prospect[] = [
  {
    ...
    "best_lng": -0.5,
    "best_zoom": 15,
    "campaign_commune": "Lyon",
    "place_id": "ChIJNABCDEFGHIJKLMNOPQR",
    "review_count": 3,
    "rating": 3.8,
    "photo_count": 0,
    "gbp_completeness": 20,
  ...
  },
  {
    ...
    "best_zoom": 16,
    "campaign_commune": "Lyon",
    "place_id": "ChIJQDEFGHIJKLMNOPQRSTU",
    "review_count": 11,
    "rating": 4.1,
    "photo_count": 2,
    "gbp_completeness": 31,
  ...
  },
  {
    ...
    "best_zoom": 17,
    "campaign_commune": "Lyon",
    "place_id": "ChIJNGHIJKLMNOPQRSTUVWX",
    "review_count": 6,
    "rating": 3.5,
    "photo_count": 1,
    "gbp_completeness": 29,
  ...
  },
  {
    ...
    "best_zoom": 15,
    "campaign_commune": "Lyon",
    "place_id": "ChIJQJKLMNOPQRSTUVWXYZA",
    "review_count": 34,
    "rating": 4.6,
    "photo_count": 9,
    "gbp_completeness": 53,
    "is_claimed": false,
    "website_kind": "own",
    "website": "https://exemple-site-1.fr",
    "seo_score": 36,
    "phone": "+33478100411",
  ...
  },
  {
    ...
    "best_lng": 0.424,
    "best_zoom": 16,
    "campaign_commune": "Paris",
    "place_id": "ChIJNMNOPQRSTUVWXYZABCD",
    "review_count": 4,
    "rating": 3.6,
    "photo_count": 0,
    "gbp_completeness": 64,
  ...
  },
  {
    ...
    "best_zoom": 17,
    "campaign_commune": "Paris",
    "place_id": "ChIJQPQRSTUVWXYZABCDEFG",
    "review_count": 19,
    "rating": 4.0,
    "photo_count": 4,
    "gbp_completeness": 75,
  ...
  },
  {
    ...
    "best_lng": 0.886,
    "best_zoom": 15,
    "campaign_commune": "Lille",
    "place_id": "ChIJNSTUVWXYZABCDEFGHIJ",
    "review_count": 2,
    "rating": null,
    "photo_count": null,
    "gbp_completeness": 44,
  ...
  },
  {
    ...
    "best_zoom": 16,
    "campaign_commune": "Lille",
    "place_id": "ChIJQVWXYZABCDEFGHIJKLM",
    "review_count": 7,
    "rating": 3.9,
    "photo_count": 1,
    "gbp_completeness": 32,
  ...
  },
  {
    ...
    "best_zoom": 17,
    "campaign_commune": "Paris",
    "place_id": "ChIJNYZABCDEFGHIJKLMNOP",
    "review_count": 15,
    "rating": 4.2,
    "photo_count": 3,
    "gbp_completeness": 43,
  ...
  },
  {
    ...
    "best_zoom": 15,
    "campaign_commune": "Paris",
    "place_id": "ChIJQBCDEFGHIJKLMNOPQRS",
    "review_count": 9,
    "rating": 4.0,
    "photo_count": 2,
    "gbp_completeness": 54,
  ...
  },
  {
    ...
    "best_zoom": 16,
    "campaign_commune": "Lyon",
    "place_id": "ChIJNEFGHIJKLMNOPQRSTUV",
    "review_count": 22,
    "rating": 4.5,
    "photo_count": 11,
    "gbp_completeness": 65,
    "is_claimed": true,
    "website_kind": "own",
    "website": "https://exemple-site-2.fr",
    "seo_score": 30,
    "phone": "+33478101370",
  ...
  },
  {
    ...
    "best_zoom": 17,
    "campaign_commune": "Lyon",
    "place_id": "ChIJQHIJKLMNOPQRSTUVWXY",
    "review_count": 5,
    "rating": 4.1,
    "photo_count": 0,
    "gbp_completeness": 22,
  ...
  },
  {
    ...
    "best_zoom": 15,
    "campaign_commune": "Lyon",
    "place_id": "ChIJNKLMNOPQRSTUVWXYZAB",
    "review_count": 8,
    "rating": 3.9,
    "photo_count": 2,
    "gbp_completeness": 22,
  ...
  },
  {
    ...
    "best_zoom": 16,
    "campaign_commune": "Paris",
    "place_id": "ChIJQNOPQRSTUVWXYZABCDE",
    "review_count": 3,
    "rating": 3.7,
    "photo_count": 1,
    "gbp_completeness": 33,
  ...
  },
  {
    ...
    "best_zoom": 17,
    "campaign_commune": "Paris",
    "place_id": "ChIJNQRSTUVWXYZABCDEFGH",
    "review_count": 27,
    "rating": 4.4,
    "photo_count": 7,
    "gbp_completeness": 44,
    "is_claimed": true,
    "website_kind": "own",
    "website": "https://exemple-site-3.fr",
    "seo_score": 58,
    "phone": "+33141019180",
  ...
  },
  {
    ...
    "best_zoom": 15,
    "campaign_commune": "Paris",
    "place_id": "ChIJQTUVWXYZABCDEFGHIJK",
    "review_count": 6,
    "rating": 3.8,
    "photo_count": 0,
    "gbp_completeness": 55,
  ...
  },
  {
    ...
    "best_zoom": 16,
    "campaign_commune": "Lille",
    "place_id": "ChIJNWXYZABCDEFGHIJKLMN",
    "review_count": 9,
    "rating": 4.0,
    "photo_count": 3,
    "gbp_completeness": 66,
  ...
  },
  {
    ...
    "best_zoom": 17,
    "campaign_commune": "Lille",
    "place_id": "ChIJQZABCDEFGHIJKLMNOPQ",
    "review_count": 4,
    "rating": null,
    "photo_count": null,
    "gbp_completeness": 57,
    "is_claimed": true,
    "website_kind": "own",
    "website": "https://exemple-site-4.fr",
    "seo_score": 42,
    "phone": "+33320102329",
  ...
  },
  {
    ...
    "best_zoom": 15,
    "campaign_commune": "Paris",
    "place_id": "ChIJNCDEFGHIJKLMNOPQRST",
    "review_count": 10,
    "rating": 4.0,
    "photo_count": 2,
    "gbp_completeness": 23,
  ...
  },
  {
    ...
    "best_zoom": 16,
    "campaign_commune": "Paris",
    "place_id": "ChIJQFGHIJKLMNOPQRSTUVW",
    "review_count": 1,
    "rating": 3.5,
    "photo_count": 0,
    "gbp_completeness": 34,
  ...
  },
  {
    ...
    "best_zoom": 17,
    "campaign_commune": "Lyon",
    "place_id": "ChIJNIJKLMNOPQRSTUVWXYZ",
    "review_count": 18,
    "rating": 4.7,
    "photo_count": 6,
    "gbp_completeness": 45,
  ...
  },
  {
    ...
    "best_zoom": 15,
    "campaign_commune": "Lyon",
    "place_id": "ChIJQLMNOPQRSTUVWXYZABC",
    "review_count": 25,
    "rating": 4.5,
    "photo_count": 4,
    "gbp_completeness": 56,
    "is_claimed": false,
    "website_kind": "own",
    "website": "https://exemple-site-6.fr",
    "seo_score": 52,
    "phone": "+33478102877",
  ...
  },
  {
    ...
    "best_zoom": 16,
    "campaign_commune": "Lyon",
    "place_id": "ChIJNOPQRSTUVWXYZABCDEF",
    "review_count": 6,
    "rating": 4.0,
    "photo_count": 1,
    "gbp_completeness": 67,
  ...
  },
  {
    ...
    "best_zoom": 17,
    "campaign_commune": "Lyon",
    "place_id": "ChIJQRSTUVWXYZABCDEFGHI",
    "review_count": 2,
    "rating": 3.6,
    "photo_count": 0,
    "gbp_completeness": 33,
  ...
  },
  {
    ...
    "best_zoom": 15,
    "campaign_commune": "Paris",
    "place_id": "ChIJNUVWXYZABCDEFGHIJKL",
    "review_count": 41,
    "rating": 4.8,
    "photo_count": 9,
    "gbp_completeness": 24,
    "is_claimed": true,
    "website_kind": "own",
    "website": "https://exemple-site-7.fr",
    "seo_score": 18,
    "phone": "+33141032880",
  ...
  },
  {
    ...
    "best_zoom": 16,
    "campaign_commune": "Paris",
    "place_id": "ChIJQXYZABCDEFGHIJKLMNO",
    "review_count": 5,
    "rating": 3.9,
    "photo_count": 1,
    "gbp_completeness": 35,
  ...
  },
  {
    ...
    "is_claimed": false,
    "website_kind": "own",
    "website": "https://exemple-site-8.fr",
    "seo_score": 39,
    "phone": "+33320103699",
  ...
  },
  {
    ...
    "is_claimed": true,
    "website_kind": "own",
    "website": "https://exemple-site-9.fr",
    "seo_score": 60,
    "phone": "+33478104110",
  ...
  },
  {
    ...
    "is_claimed": true,
    "website_kind": "own",
    "website": "https://exemple-site-11.fr",
    "seo_score": 47,
    "phone": "+33320104932",
...
export type ProspectFilters = {
  ...
  search: string;
  // Date range on measured_at (scan date), NOT delivered_at -- a lead
  // delivered today may have been scanned weeks ago (snapshots are
  // reused within their TTL), so "what's fresh" means measured_at.
  // Empty string = no bound on that side. Client-side, per spec -- no
  // query change, filters the fetched page rather than the database.
  measuredFrom: string;
  measuredTo: string;
};
...
export type ProspectSortKey = 'best_rank' | 'potentiel' | 'rating' | 'delivered_at' | 'measured_at';
...
// Distinguishes "no data at all" from "no results for the current
// filters" -- fixes the pre-existing bug where hasAnyProspectsEver in
// prospects/page.tsx was declared but never set (null !== false, so
// that branch could never trigger). Deliberately unfiltered and
// ignores the tab -- if this respected the current filters, a search
// matching nothing would look identical to "this agency has never had
// any prospects at all," showing the wrong empty state to an existing
// customer. Only needs to tell zero from non-zero, so a head-only count
// is enough; run once on mount, not on every filter change.
export async function fetchHasAnyProspects(): Promise<boolean> {
  const supabase = createClient();
  const { count, error } = await supabase
    .from('prospect_view')
    .select('id', { count: 'exact', head: true });
  if (error) {
    console.error('fetchHasAnyProspects query failed', error);
    return false;
  }
  return (count ?? 0) > 0;
}
...
export async function searchCommunes(query: string, limit = 8): Promise<CommuneSearchResult> {
  ...
  const supabase = createClient();
  const { data, error } = await supabase.rpc('search_communes', { p_query: q, p_limit: limit });
  if (error) {
    console.error('searchCommunes RPC failed', error);
    return { results: [], totalMatches: 0 };
  }
  const rows = (data as any[]) ?? [];
  return {
    // total_matches is repeated on every row (how one query returns both
    // the page and the true count against all 34,746 communes) -- stripped
    // out here since it's not part of the Commune shape.
    results: rows.map(({ total_matches, ...c }) => c as Commune),
...
export async function getCommuneByCodeInsee(code: string): Promise<Commune | null> {
  ...
  const { data, error } = await supabase
    .from('communes')
    .select('code_insee, nom, slug, dept_code, region_name, population')
    .eq('code_insee', code)
    .maybeSingle();
  if (error) {
    console.error('getCommuneByCodeInsee query failed', error);
    return null;
  }
  return (data as Commune | null) ?? null;
}
...
// NOR an active region row -- should be rare in practice, but a safe
// final fallback rather than crashing.
const NO_COMMUNE_FALLBACK: Commune = {
  code_insee: '',
  nom: 'France',
  slug: '',
  dept_code: '',
...
// Shared by fetchCampaignsOverview and fetchCampaign -- both run the same
// nested select and need the same three flattening steps applied to each
// row, so this is written once rather than duplicated.
function mapCampaignRow(row: any, businessesFound: number): Campaign {
  // Fallback chain per Opus: commune -> active region -> "France".
  // "France" alone would discard something real -- a region-scoped
  // campaign was genuinely scoped to e.g. Hauts-de-France, and an
  // agency looking at their own history should see that, not a country.
  const communeRow = row.campaign_communes?.[0]?.communes;
  if (communeRow) {
    return {
      id: row.id,
      keyword: row.campaign_keywords?.[0]?.keyword ?? '',
      commune: communeRow,
      status: row.status,
      total_grids: row.total_grids,
      completed_grids: row.completed_grids,
      businesses_found: businessesFound,
      created_at: row.created_at,
      completed_at: row.completed_at,
    };
  }
  // A deactivated region row should not be displayed -- filtered
  // client-side rather than in the query itself, to avoid the risk of a
  // nested Postgrest filter silently excluding the whole campaign row
  // if written wrong, which would be a much worse bug than showing the
  // wrong fallback name.
  const activeRegion = (row.campaign_regions as { region_name: string; status: string }[] | undefined)?.find(
    (r) => r.status === 'active',
  );
  const regionName = activeRegion?.region_name ?? 'France';
  return {
    id: row.id,
    keyword: row.campaign_keywords?.[0]?.keyword ?? '',
    commune: { ...NO_COMMUNE_FALLBACK, nom: regionName, region_name: regionName },
    status: row.status,
    total_grids: row.total_grids,
    completed_grids: row.completed_grids,
    businesses_found: businessesFound,
...
// businesses_found isn't a column on campaigns -- it's a sum across that
// campaign's grid rows. One extra query for the whole list (keyed by
// campaign_id), not one query per campaign.
async function fetchBusinessesFoundByCampaign(
  ...
  const { data, error } = await supabase
    .from('campaign_grids')
    .select('campaign_id, businesses_found')
    .in('campaign_id', campaignIds);
  if (error) {
    console.error('fetchBusinessesFoundByCampaign query failed', error);
    return {};
  }
  const sums: Record<string, number> = {};
  for (const row of (data as { campaign_id: string; businesses_found: number }[]) ?? []) {
    sums[row.campaign_id] = (sums[row.campaign_id] ?? 0) + (row.businesses_found ?? 0);
  }
  return sums;
}

const CAMPAIGN_SELECT = `
  id, status, total_grids, completed_grids, created_at, completed_at,
  campaign_keywords ( keyword ),
  campaign_communes ( communes ( code_insee, nom, slug, dept_code, region_name, population ) ),
  campaign_regions ( region_name, status )
`;
...
export async function fetchCampaignsOverview(): Promise<{
  ...
  const supabase = createClient();
  // No agency_id filter -- RLS scopes this to the current agency.
  const { data, error } = await supabase
    .from('campaigns')
    .select(CAMPAIGN_SELECT)
    .order('created_at', { ascending: false });
  if (error) {
    console.error('fetchCampaignsOverview query failed', error);
  }
  const rows = (data as any[]) ?? [];
  const sums = await fetchBusinessesFoundByCampaign(
    supabase,
    rows.map((r) => r.id),
  );
  return {
    campaigns: rows.map((row) => mapCampaignRow(row, sums[row.id] ?? 0)),
...
export async function fetchCampaign(id: string): Promise<Campaign | null> {
  ...
  const { data, error } = await supabase
    ...
    .maybeSingle();
  if (error) {
    console.error('fetchCampaign query failed', error);
  }
  if (data === null || data === undefined) return null;
  const sums = await fetchBusinessesFoundByCampaign(supabase, [id]);
  return mapCampaignRow(data, sums[id] ?? 0);
}
...
export async function fetchCampaignProgress(id: string): Promise<CampaignProgress | null> {
  ...
  // Three separate counts, not one query with all three conditions
  // chained -- chaining would only answer "how many are both enriched
  // AND delivered". campaign_id assumed to exist directly on leads, per
  // the spec's own example -- if this specific query fails, that's the
  // one thing to check: leads may only carry campaign_grid_id, needing
  // a join through campaign_grids instead. No way to confirm the live
  // schema from here, so this is built as given and will fail loudly
  // (logged below) rather than silently if that assumption is wrong.
  ...
  const [scanResult, qualifiedResult, enrichedResult, deliveredResult] = await Promise.all([
    scanQuery,
    qualifiedQuery,
    enrichedQuery,
    deliveredQuery,
...
// Agency is NEVER a parameter here -- resolved from auth.uid() inside
// create_campaign itself. A client-supplied agency_id could create
// campaigns in someone else's account, spending their quota and real
// money on scans.
//
// One RPC, not four client-side writes (campaign, commune, keyword,
// grid rows) -- a failure between any two of those leaves wreckage that
...
export async function createCampaign(input: {
  ...
  if (error) {
    ...
    // user in practice, since the form prevents both.
    return { ok: false, message: error.message };
  }
  const row = (data as { campaign_id: string; grid_points: number; keyword: string }[])?.[0];
  if (row === undefined) {
    console.error('createCampaign: RPC succeeded but returned no row', data);
    return { ok: false, message: 'Une erreur est survenue. Réessayez.' };
  }
  return { ok: true, campaignId: row.campaign_id, gridPoints: row.grid_points };
}
